...
hist(examp1$data, breaks=100, main="")
...
rawuncertgraph(modelpickobject1, title="")
rawdistgraph(modelpickobject1, title="")
rawhistcuts(modelpickobject1, title="")

cutoffobject1<-cutoff(modelpickobj = modelpickobject1)

cutuncertgraph(cutobj = cutoffobject1, title="")
cutdistgraph(cutobj = cutoffobject1, title="")
...
examp2<-examp2[,c("id", "data")]

hist(examp2$data, breaks=100, main="")
...
rawuncertgraph(modelpickobj = modelpickobject2, title="")
rawdistgraph(modelpickobj = modelpickobject2, title="")
rawhistcuts(modelpickobj = modelpickobject2, title="")

cutoffobject2<-cutoff(modelpickobj = modelpickobject2, cutcomp = 1)

cutuncertgraph(cutobj = cutoffobject2, title="")
cutdistgraph(cutobj = cutoffobject2, title="")
