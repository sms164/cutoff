...
#bicgraph(model=fitloopsobject1)

#modelpickobject2<-modelpick(fitloopsobject1)

#rawuncertgraph(modelpickobject1)
#rawdistgraph(modelpickobject1)
#rawhistcuts(modelpickobject1)
...
cutoffobject2<-cutoff(modelpickobj = modelpickobject2, cutcomp = 1)
